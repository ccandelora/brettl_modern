class DropSolidQueueTables < ActiveRecord::Migration[8.0]
  def up
    # Drop all solid_queue tables in the correct order (respecting foreign key constraints)
  ...
  def down
    # This migration is irreversible - we're removing solid_queue functionality
